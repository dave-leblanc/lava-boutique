...
running  "cron" jobs on Firebase is not natively supported.
There are 2 ways to achieve this provided by Firebase:
Creating an App Engine Shim
https://firebase.googleblog.com/2017/03/how-to-schedule-cron-jobs-with-cloud.html
 and relying on external scheduling services to call HTTP functions
https://github.com/firebase/functions-samples/tree/master/delete-unused-accounts-cron

Here we are going to take the second approach and simply provide an HTTP function that could be scheduled periodically.
